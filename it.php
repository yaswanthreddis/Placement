...
<!-- End Header -->
  ...
  <section id="it" class="about section-bg">
    ...
    transition: background-color 0.3s ease" href="student.php?id=<?php echo $res['id'];?>">View</a></td>
      ...
      <?php }?>
      <?php if ($var == 1 && $data->num_rows > 0) { ?>
    <div class="center-container">
        <a href="download.php?dept=<?php echo $dept; ?>&batch=<?php echo $batch; ?>&percentage=<?php echo $percentage; ?>" class="btn-download btn btn-primary">Download as Spreadsheet</a>
    </div>
<?php } ?>
